...
increaseDoseValue:	PUSHF
					...
					ldi r24,0
					ldi r25,0
					LDI_B maxDoseValue				;	максимальный разовый объем
					call CP_AB
					brcs idv1000_5000
					ldi r22, low(maxDoseValue)
					ldi r23,high(maxDoseValue)
					LDI_B 0
					rjmp idvAdd
